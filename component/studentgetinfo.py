...
def studentgetinfo(userID):
   ...
   # time.
    ...
    studentgetinfo = service.courses().students().get(
        courseId='19606736198',userId=userID).execute()
...
if __name__ == '__main__':
    students = studentgetinfo(107235148265490091119)
    print(students)
